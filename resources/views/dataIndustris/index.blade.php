...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <button type="button" href="{{ route('dataIndustris.create') }}" class="btn btn-success" data-toggle="modal"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('dataIndustris.store') }}" method="POST">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>RT:</strong>
                                    <input type="number" name="rt" class="form-control" min="-1"
                                        placeholder="RT">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>RW:</strong>
                                    <input type="number" name="rw" class="form-control" min="-1"
                                        placeholder="rw">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                ...
                serverSide: true,
                scrollX: true,
                ajax: "{{ route('dataIndustris.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
