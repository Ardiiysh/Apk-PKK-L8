...
<div class="btn-group">
   ...
   <br>
    ...
    <table class="table table-bordered ">
        ...
        $i = 0;
        @endphp
        @foreach ($rekapitulasiKelompokDasawismas as $rekapitulasiKelompokDasawisma)
        <tr>


            <td>{{ ++$i }}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->id_dasawisma}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->rt }}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->rw}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->kelurahan}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->kecamatan}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->kabupaten_kota}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->provinsi}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->tahun}}</td>
            <td>{{ $rekapitulasiKelompokDasawisma->keterangan}}</td>
            <td>
                <form onsubmit="return confirm('Apakah anda yakin ingin menghapus  ?');"  action="{{ route('rekapitulasiKelompokDasawismas.destroy',$rekapitulasiKelompokDasawisma->id_rekapitulasi_kelompok_dasawisma) }}" method="POST">

                    {{-- <a class="btn btn-info" href="{{ route('rekapitulasiKelompokDasawismas.show',$rekapitulasiKelompokDasawisma->id) }}">Show</a> --}}
    
                    <a class="btn btn-primary" href="{{ route('rekapitulasiKelompokDasawismas.edit',$rekapitulasiKelompokDasawisma->id_rekapitulasi_kelompok_dasawisma) }}" ><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
