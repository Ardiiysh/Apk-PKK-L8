        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->kepala_rumah_tangga.' ?\');"  action="rekaptilulasiLahirMatis/'.$row->id_catatan_keluarga.'" method="POST">

                            <a class="btn btn-primary" href="rekaptilulasiLahirMatis/'.$row->id_catatan_keluarga.'/edit" >
