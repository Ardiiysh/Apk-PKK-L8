        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->nama_pelatihan.' ?\');"  action="pelatihans/'.$row->id_pelatihan.'" method="POST">

                            <a class="btn btn-primary" href="pelatihans/'.$row->id_pelatihan.'/edit" >
