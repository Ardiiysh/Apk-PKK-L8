...
class RekapitulasiKelahiranKematianController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus  ?\');"  action="rekapitulasiKelahiranKematians/'.$row->id_rekapitulasi_kelahiran_kematian.'" method="POST">

                            <a class="btn btn-primary" href="rekapitulasiKelahiranKematians/'.$row->id_rekapitulasi_kelahiran_kematian.'/edit" >
    ...
    {
        return view('rekapitulasiKelahiranKematians.create');
    ...
    public function store(Request $request)
    {
        $request->validate([
         ...
         RekapitulasiKelahiranKematian::create($request->all());

        return redirect()->route('rekapitulasiKelahiranKematians.index')
                        ->with('success','RekapitulasiKelahiranKematian created successfully.');
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\Models\RekapitulasiKelahiranKematian  $rekapitulasiKelahiranKematian
     * @return \Illuminate\Http\Response
     */
    public function show(RekapitulasiKelahiranKematian $rekapitulasiKelahiranKematian)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(RekapitulasiKelahiranKematian $rekapitulasiKelahiranKematian)
    {
        $rekapitulasiKelahiranKematian->delete();

        return redirect()->route('rekapitulasiKelahiranKematians.index')
                        ->with('success','rekapitulasiKelahiranKematian deleted successfully');
    }
}
