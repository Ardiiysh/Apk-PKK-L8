        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->id_warga.' ?\');"  action="kegiatanWargas/'.$row->id.'" method="POST">

                            <a class="btn btn-primary" href="kegiatanWargas/'.$row->id.'/edit" >
