        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->jenis_buku.' ?\');"  action="bukus/'.$row->id.'" method="POST">

                            <a class="btn btn-primary" href="bukus/'.$row->id.'/edit" >
