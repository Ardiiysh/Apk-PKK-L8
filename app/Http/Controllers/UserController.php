...
class UserController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->name.' ?\');"  action="dataUser/'.$row->id.'" method="POST">
    ...
    public function store(Request $request)
    {
        ...
        if ($input['password'] == $input['password2']) {
            ...
            return redirect()->route('dataUser.index')->with('success', 'User created succesfully');
        }else{
            return redirect()->route('dataUser.index')->with('error', 'passwords do not match');
        }
    }
    ...
    public function destroy(User $dataUser)
    {
        ...
        if ($cek) {
            ...
            return redirect()->back()->with('error', 'Deleted user Unsuccessfully');
        }
    }
}
