        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->nama_desa.' ?\');"  action="desas/'.$row->id.'" method="POST">

                            <a class="btn btn-primary" href="desas/'.$row->id.'/edit" >
