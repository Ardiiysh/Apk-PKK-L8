...
class DataPenyuluhanController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->id_dasawisma.' ?\');"  action="dataPenyuluhans/'.$row->id_data_penyuluhan.'" method="POST">

                            <a class="btn btn-primary" href="dataPenyuluhans/'.$row->id_data_penyuluhan.'/edit" >
    ...
    {
        return view('dataPenyuluhans.create');
    ...
    public function store(Request $request)
    {
        ...
        DataPenyuluhan::create($request->all());

        return redirect()->route('dataPenyuluhans.index')
                        ->with('success','Data Hatinya created successfully.');
    }
    /**
     * Display the specified resource.
     *
     * @param  \App\Models\DataPenyuluhan  $dataPenyuluhan
     * @return \Illuminate\Http\Response
     */
    public function show(DataPenyuluhan $dataPenyuluhan)
    {
        //
    }
    ...
    public function update(Request $request, DataPenyuluhan $dataPenyuluhan)
    {
        $request->validate([
         ...
         $dataPenyuluhan->update($request->all());
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(DataPenyuluhan $dataPenyuluhan)
    {
        $dataPenyuluhan->delete();
