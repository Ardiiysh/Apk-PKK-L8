        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->id_dasawisma.' ?\');"  action="wargas/'.$row->id_warga.'" method="POST">

                            <a class="btn btn-primary" href="wargas/'.$row->id_warga.'/edit" >
