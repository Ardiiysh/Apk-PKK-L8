...
class DataIndustriRumahTanggaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->jenis_buku.' ?\');"  action="dataIndustriRumahTanggas/'.$row->id_data_industri_rumah_tangga.'" method="POST">

                            <a class="btn btn-primary" href="dataIndustriRumahTanggas/'.$row->id_data_industri_rumah_tangga.'/edit" >
        ...
        return view('dataIndustriRumahTanggas.index');
    }
