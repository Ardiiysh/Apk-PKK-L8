...
class DataAsetDesaController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        ...
                        $btn = '
                        <form onsubmit="return confirm(\'Apakah anda yakin ingin menghapus '.$row->id_data_aset.' ?\');"  action="dataAsetDesas/'.$row->id_data_aset_desa.'" method="POST">

                            <a class="btn btn-primary" href="dataAsetDesas/'.$row->id_data_aset_desa.'/edit" >
        ...
        return view('dataAsetDesas.index');
    }

    public function export_excel()
	{
        $name = 'Laporan Data Aset Desa '. date('Y-m-d', time());
		return Excel::download(new DataAsetDesaExport, $name . '.xlsx');
	}

    public function export_pdf()
    {
        $dataAsetDesa = $this->dataSort();
